...
public class mainFunctions {
    ...
    public WebElement FindElementByXpath(String id) throws Exception {
        WebElement xPathofId = driver.findElement(By.xpath(id));
        //System.out.println("Xpath is: '"+xPathofId+"");
        return xPathofId;
    }
    ...
    public List WebElementsById(String id) throws Exception {
        List tempElement = driver.findElements(By.id(id));
        if (tempElement.size() < 1) {
            swipeDown();
            tempElement = driver.findElements(By.id(id));
            if (tempElement.size() < 1) {
    ...
    public WebElement WebElementById(String id) throws Exception {
        WebElement tempElement = driver.findElement(By.id(id));
        return tempElement;
    }
    ...
    public WebElement WebElementByAccessibilityId(String accessibilityid) throws Exception {
        WebElement tempElement = driver.findElement(By.name(accessibilityid));
        return tempElement;
    }
    ...
    public WebElement WebElementSettingSwitchByText(String text, Boolean isCapitalized) throws Exception {
        ...
        WebElement tempElement = driver.findElement(By.xpath("//android.widget.TextView[@text='" + text + "']/../../android.widget.LinearLayout/android.widget.Switch"));
        return tempElement;
    }
...
//    }
    ...
    public WebElement WebElementByXpath(String text) throws Exception {
        WebElement tempElement = driver.findElement(By.xpath(text));
        return tempElement;
    }
    ...
    public void ClickUIElementByAccessibilityID(String elementAccessibilityID) throws Exception {
        ...
        WebElement itemToClick = (WebElement) driver.findElements(By.name(elementAccessibilityID));
        itemToClick.click();
    ...
    public void ClickUIElementByID(String elementID) throws Exception {
        ...
        WebElement itemToClick = driver.findElement(By.id(elementID));
        itemToClick.click();
    ...
    public void ClickUIElementByXpath(String xpath) throws Exception {
        ...
        WebElement itemToClick = driver.findElement(By.xpath(xpath));
        itemToClick.click();
...
//                "width", screenWidth / 2, "height", screenHeight / 10 * 2,
//                "direction", "down",
//                "percent", 3.0
//        ));
...
//    }
    ...
    public void dismissDialog(WebElement dialogBox) throws Exception {
        ...
        TouchAction action = new TouchAction((PerformsTouchActions) driver);
        action.tap(point(xTapPoint, yTapPoint)).perform();
        Thread.sleep(1000);
    }
...
//    }
    ...
    public void ParentalQuestion() throws Exception{
        ...
        Question = driver.findElement(By.xpath("/hierarchy/android.view.ViewGroup/android.view.View/android.view.View/android.widget.ScrollView/android.widget.TextView[3]")).getText();
...
//    }
    ...
    public void SplashScreenWait() throws Exception {
        ...
        Boolean isPresent = driver.findElements(By.id("org.lds.justserve.alpha:id/action_bar_root")).size() > 0;
        while (isPresent) {
    ...
    public void LoggingInScreenWait() throws Exception {
        ...
        Boolean isPresent = driver.findElements(By.id(AppId("action_bar_root"))).size() > 0;
        while (isPresent) {
...
//        assertElementExistsBy(WebElementsByXpath("(//*/android.widget.TextView)[4]"));
    ...
    public void performOrientation() throws InterruptedException {
        ...
        System.out.println("Current screen orientation Is : " + "\033[34m " + driver.getEvents() + "\033[0m");
        ...
        while( totalTime <= 65000)
        {
            ...
            System.out.println("Now screen orientation Is : " + "\033[33m " + driver.getEvents() + "\033[0m");
            Thread.sleep(500);
            count++;
            ...
            //Get and print screen orientation after changing It.
            System.out.println("Now screen orientation Is : " + "\033[34m " + driver.getEvents() + "\033[0m");
            Thread.sleep(500);
            count++;
